...
// Added so the debug colours can be passed easily
uniform vec4 DebugObjectColourOverride;		// If the w is != 0, this colour is used
		
out vec4 ex_Position;
out vec4 ex_Color;
out vec3 ex_Normal;			// Note Normal is a vec3
out vec4 ex_DebugObjectColourOverride;	
...
{	
	...
	ex_DebugObjectColourOverride = DebugObjectColourOverride;
