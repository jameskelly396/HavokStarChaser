...
//*********************************************************************************************************/
// We only need to do this in damn release mode since The Great Windows won't return the 
...
bool CXBoxController::Init(void)
{
	...
	//CXBoxController::pXboxInputGetState = (CXBoxController::XBoxInputGetState)::GetProcAddress( GetModuleHandle(L"Xinput9_1_0.dll"), "XInputGetState" );
...
// inspired from: http://www.third-helix.com/2013/04/12/doing-thumbstick-dead-zones-right.html
